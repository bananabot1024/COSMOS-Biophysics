...
totalHits = 0;
totalSteps = 0;
walk_steps = np.zeros(1000)  # Tracks number of steps for each walk
...
for n in range(0, 1000):
	...
	if n == 5:
		...
		ax.set_title('Sample Random Walker in a Sphere')
...
plt.title('Histogram of Steps to Target for a Sphere ' )
