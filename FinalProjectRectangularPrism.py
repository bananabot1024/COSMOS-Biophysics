...
#	 boundary  = shapes.Ellipsoid((0.0, 0.0, 0.0), 25, 44, 25) #115,000
boundary  = shapes.Rectangle3d((0.0, 0.0,0.0), 45, 42, 60) #113,400
#	 boundary  = shapes.Sphere((0.0, 0.0, 0.0), 30) #116,000
...
for n in range(0, 100):
	...
	if n == 5:
		...
		ax.set_title('Sample Random Walker in a Rectangular Prism')
...
plt.title('Histogram of Steps to Target for a Rectangular Prism ' )
